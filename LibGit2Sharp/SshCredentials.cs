...
//  Code from here: https://github.com/alex-weaver/libgit2sharp/commit/2ab9fdd14f43dd63c7e4406768d3d6799fb68bc4
...
namespace LibGit2Sharp.Ssh
{
    internal static class NativeMethods
    {
        ...
        [DllImport(libgit2)]
        internal static extern int git_credential_ssh_key_new(
             out IntPtr cred,
        ...
        [DllImport(libgit2)]
        internal static extern int git_credential_ssh_key_memory_new(
              out IntPtr cred,
              [MarshalAs(UnmanagedType.CustomMarshaler, MarshalCookie = UniqueId.UniqueIdentifier, MarshalTypeRef = typeof(StrictUtf8Marshaler))] string username,
              [MarshalAs(UnmanagedType.CustomMarshaler, MarshalCookie = UniqueId.UniqueIdentifier, MarshalTypeRef = typeof(StrictUtf8Marshaler))] string publickey,
              [MarshalAs(UnmanagedType.CustomMarshaler, MarshalCookie = UniqueId.UniqueIdentifier, MarshalTypeRef = typeof(StrictUtf8Marshaler))] string privatekey,
    ...
    public sealed class SshUserKeyCredentials : Credentials
    {
        ...
        internal protected override int GitCredentialHandler(out IntPtr cred)
        {
            ...
            return NativeMethods.git_credential_ssh_key_new(out cred, Username, PublicKey, PrivateKey, Passphrase);
        }
    ...
    public sealed class SshUserKeyMemoryCredentials : Credentials
    {
        ...
        internal protected override int GitCredentialHandler(out IntPtr cred)
        {
            ...
            return NativeMethods.git_credential_ssh_key_memory_new(out cred, Username, PublicKey, PrivateKey, Passphrase);
        }
