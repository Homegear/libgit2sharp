...
namespace LibGit2Sharp.Tests
{
    public class FetchFixture : BaseFixture
    {
        ...
        public void FetchHonorsTheFetchPruneConfigurationEntry()
        {
            ...
            {
                Assert.Equal(5, clonedRepo.Branches.Count(b => (b.IsRemote && !b.CanonicalName.Equals("refs/remotes/origin/HEAD"))));
                ...
                Commands.Fetch(clonedRepo, "origin", new string[0], null, null);
                Assert.Equal(4, clonedRepo.Branches.Count(b => (b.IsRemote && !b.CanonicalName.Equals("refs/remotes/origin/HEAD"))));
            }
        }
